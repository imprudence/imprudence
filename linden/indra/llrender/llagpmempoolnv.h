...
#ifndef LL_LLAGPMEMPOOLNV_H
#define LL_LLAGPMEMPOOLNV_H

#include "llagpmempool.h"

class LLAGPMemPoolNV : public LLAGPMemPool
{
public:
	LLAGPMemPoolNV(int request);
	virtual ~LLAGPMemPoolNV();
...
protected:
	...
	static BOOL sWriteOK;
};

class LLAGPMemBlockNV : public LLAGPMemBlock
{
public:
	LLAGPMemBlockNV(LLAGPMemPool *mem_poolp, U8 *baseptr, const S32 offset, const U32 size);
	virtual ~LLAGPMemBlockNV() { mMemPoolp->freeBlock(this); };
...
private:
	...
	U32 mSize;
	friend class LLAGPMemPoolNV;
};

#endif // LL_LLAGPMEMPOOLNV_H
